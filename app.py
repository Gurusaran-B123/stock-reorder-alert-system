...
Flat file structure: app.py, index.html, style.css, script.js all live
in the same root folder (no templates/ or static/ subfolders).
"""
...
# template_folder="." tells Flask to look for index.html in the root dir.
# static_folder="." + static_url_path="" tells Flask to serve style.css /
# script.js directly from the root (e.g. /style.css instead of /static/style.css).
